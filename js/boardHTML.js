function toDoHtmlReturn(i){
    return `
    <div id="toDoContainer${i}" class="boxSizeProgress">
    <div class="headContainer">
      <span id="TaskCategory${i}" class="headlineFromTask font16400">Catergory</span>
      <div>
        <img src="../assets/img/board/mobile_switch.svg" />
      </div>
    </div>
    <div class="inProgressText">
      <p class="titleText font16700" id="titleId${i}">Kochwelt Page & Recipe Recommender</p>
    ...
    <div class="progressMainContainer">
      ...
      <p class="font12400">
        <p id="finishedTasks${i}">0</p>
        /
        <p id="counterOfTasks${i}">2</p>
        Subtasks
      </p>
    </div>
    <div class="progressFooter">
      <div class="IconBarClass" id="IconBar${i}">
      </div>
      <div><img id="PrioImageContainer${i}" src="../assets/img/board/board_low.svg" /></div>
    </div>
  </div>
    `
}
